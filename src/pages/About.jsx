        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground font-light leading-relaxed">
                Our Akash tyagi  laboratories employ state-of-the-art computational modeling to design molecules that target specific pest receptors, ensuring that beneficial pollinators and soil microbiomes remain completely unaffected.
              </p>
